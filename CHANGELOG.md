...
### Fixed
* Fix for UUM-138420 - Frame time values differ between Profiler and Profile Analyzer when comparing the same marker on the same frame.

## [1.3.3] - 2026-03-06

### Changed
* Removal of use of instanceID.

## [1.3.2] - 2026-02-19

### Changed
* Some performance improvements when pulling data in from the Profiler.
